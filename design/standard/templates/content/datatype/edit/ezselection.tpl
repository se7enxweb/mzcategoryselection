...
{if $attribute.class_content.is_multiselect}<span style="padding:2px;font-size:10px">Mehrfachauswahl: Halten der [Strg]-Taste (PC) / Befehlstaste (Mac) bei gleichzeitigem Anklicken der gewünschten Listeneinträge.</span>
{/if}
