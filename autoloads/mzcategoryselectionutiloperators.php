<?php
//
// Definition of mzCategorySelectionUtil class
//
...
require_once('extension/mzcategoryselection/datatypes/mzcategoryselection/mzcategoryselectiontype.php');
...
class mzCategorySelectionUtil{
      ...
      function __construct(){
	      ...
	      $this->Operators = array ('option_filter',
		                        'category_options',
       ...
       * be an mzcategoryselection type
       * Returns: options of current content object attribute to be shown according to 
       * selected options of current content object attribute's binded selection/mzcategoryselection attributes
	...
	//store current options, current categories and is_multiselect in attrValue
      ...
      */
      function &generate_category_string(&$categories){
	        ...
	        return mzCategorySelectionType::generate_category_string($categories);
      ...
      */
      function &has_related_category_options($content_class_attribute_id,
	       ...
	       foreach($class_attributes as $attribute){
		       ...
		       if($data_type_string=='mzcategoryselection' &&
      ...
      /*
       * mzcategoryselection has two attributes: 'threshold' and 'description'. 
       ...
       * mzcategoryselection attribute. Then, bind these attributes to another mzcategoryselection attribute. In this case, 
       * we actually defined a logic as the following:
       * different threshold value of the binded mzcategoryselection attribute is connected to a description statement.
       * This is useful for defining the result of a questionnaire.
       * Param: content_class_attribute_id - content class attribute id
       * Param: version_id - default 0
       * Returns: the threshold value and its description statement of all mzcategoryselection attributes that are binded
